...
flex_wfreq = np.load('./datafr/dl1_gcc_sn10000_gran1_wfreq.npy', allow_pickle = True)
num_sets_l1 = 256
num_sets_l2 = 1024
...
plt.legend()
plt.tight_layout()
plt.savefig('dl1_gcc_sn10000_comparison.png', dpi=300)
...
plt.title('Write Distribution: Flexible vs. Default for L1 Data Cache\nTask:gcc, Shift Number:10000, Granularity:1')
plt.xlabel('Physical Set Location')
plt.ylabel('Frequency')
plt.legend()
plt.tight_layout()
plt.savefig('dl1_gcc_sn10000_gran1_comparison.png', dpi=300)
